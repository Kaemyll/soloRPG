	...
	buttonCard.addEventListener('click', function() {
		...
		switch (result) {
			...
			case 3:
				...
				var upside = "A l'endroit : L'Intuition - La Spiritualité - Le Mystère";
				var reverse = "A l'envers : L'Impulsivité - Le Dogme - Le Pragmatisme";
				break;
			case 4:
				var cardValue = 3;
				var cardType = 'Arcane Majeure';
				var resultText = "L'IMPERATRICE";
				var upside = "A l'endroit : La Féminité - La Fertilité - La Sagesse";
				var reverse = "A l'envers : La Contrariété - L'Obstination - La Méchanceté";
				break;
			case 5:
				var cardValue = 4;
				var cardType = 'Arcane Majeure';
				var resultText = "L'EMPEREUR";
				var upside = "A l'endroit : Le Paternalisme - L'Enseignement - L'Autorité";
				var reverse = "A l'envers : L'Ambition - La Brutalité - La Domination";
				break;
			case 6:
				var cardValue = 5;
				var cardType = 'Arcane Majeure';
			...
			case 12:
				...
				var upside = "A l'endroit : L'Equilibre - La Balance - Le Jugement";
				var reverse = "A l'envers : La Vengeance - La Passivité - La Cruauté";
				break;
			case 13:
				var cardValue = 12;
				var cardType = 'Arcane Majeure';
			...
			case 14:
				...
				var upside = "A l'endroit : Le Changement - - ";
				var reverse = "A l'envers : La Stagnation - - ";
				break;
			case 15:
				var cardValue = 14;
				var cardType = 'Arcane Majeure';
			...
			case 16:
				...
				var upside = "A l'endroit : La Tentation - L'Esclavage - La Souffrance";
				var reverse = "A l'envers : La Délivrance - - ";
				break;
			case 17:
				var cardValue = 16;
				var cardType = 'Arcane Majeure';
